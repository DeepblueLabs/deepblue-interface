...
export const HeroImage = () => {
  ...
  return (
    <div ref={ref} className="mt-[2.8rem] [perspective:2000px]">
      <div
        className={classNames(
          "relative rounded-lg border border-transparent-grey-dark bg-black bg-opacity-[0.01] bg-hero-gradient",
